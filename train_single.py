...
class Instructor:
    ...
    def run(self):
        ...
        scheduler = optimization.get_linear_schedule_with_warmup(optimizer, num_warmup_steps=warmup_steps, num_training_steps=total_steps)
...
def main():
    ...
    input_colses = {
        'ASFEN': ['text_bert_indices', 'bert_segments_ids', 'attention_mask', 'asp_start', 'asp_end', 'src_mask', 'aspect_mask', 'short_mask', 's1_input_ids', 's1_attention_mask', 's2_input_ids', 's2_attention_mask']
    }
    ...
    parser.add_argument('--log_step', default=5, type=int)  # 5
    parser.add_argument('--embed_dim', default=300, type=int)
    parser.add_argument('--post_dim', type=int, default=30, help='Position embedding dimension.')
    parser.add_argument('--pos_dim', type=int, default=30, help='Pos embedding dimension.')
    parser.add_argument('--hidden_dim', type=int, default=1024, help='GCN mem dim.')
    ...
    parser.add_argument('--max_length', default=100, type=int)  # 99
    ...
    parser.add_argument('--diff_lr', default=False, action='store_true')  # False
